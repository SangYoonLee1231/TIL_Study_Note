...
* <a href="https://github.com/SangYoonLee1231/TIL/blob/main/Python/python_1d_list.md#1%EC%B0%A8%EC%9B%90-%EB%A6%AC%EC%8A%A4%ED%8A%B8-%EC%9E%85%EB%A0%A5-inputsplit-%ED%99%9C%EC%9A%A9%EB%B2%95"><code>1차원 리스트 입력 (input().split())</code> 활용법</a>
...
* <a href="">자주 쓰이는 리스트 함수 (append, pop, len, sum 함수)</a>
...
* <a href="">자주 쓰이는 리스트 함수 2 (index, count, max, min 함수)</a>
